  ...
  return (
    <section id="role" className= {styles.nghiepvu} >
      <div className={`${styles.roleSection} ${isVisible ? styles.visible : ''}`} ref={sectionRef}>
        <p  data-aos="fade-right" data-aos-duration="1000">&quot;Khi nghiệp vụ không chỉ nằm ở sự chuyên nghiệp mà còn là sự phá cách. Giữa bàn cờ cuộc sống, hãy dựng lên sân khấu đặc sắc nhất để làm nên một tác phẩm của riêng mình&quot;</p>
