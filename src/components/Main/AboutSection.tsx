      ...
      <div className={styles.Main_section} id = "about">
         ...
         <div>
           <div data-aos="fade-up" data-aos-duration="1000">
              ...
              <ul>
                <li><p>Hiện tại mình đang là sinh viên năm hai của trường đại học Mở TP.Hồ Chí Minh.
                  Ngành học của mình là công nghệ thông tin với định hướng chuyên ngành là an toàn thông tin, hệ thống quản lý.
                ...
                <li><p>Sở thích của mình là nghe nhạc (chủ yếu Billie Eilish và Imagine Dragons), đồng thời mình khá thích coding trong thời gian rảnh
                  ...
                  <li><p>Mục tiêu của mình là tiếp tục phấn đấu cải thiện kỹ năng chuyên ngành để nâng cao chất lượng các dự án cá nhân và cộng đồng. Đồng thời là cải thiện các kỹ năng khác như tiếng Anh và giao tiếp để nâng cao chất lượng trong cuộc sống và công việc</p></li>
              </ul>
            </div>
            <hr></hr>
